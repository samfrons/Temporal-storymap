...
// Add this function to create and initialize the time slider
...
// Modify the existing createMarkers function (or add this if it doesn't exist)
...
// here
        for (var j = 1; j <= 3; j++) {  // Assuming up to 3 media entries per chapter
    var mediaLink = c['Media Link ' + j];
    var mediaCredit = c['Media Credit ' + j];
    var mediaCreditLink = c['Media Credit Link ' + j];
...
// Add this function to update markers based on the current year
